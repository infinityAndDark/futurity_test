...
public class StringUtil {
    ...
    public static String getNumberText(Object number) {
    ...
    public static boolean isValidPersonalID(String ID){
    ...
    public static String getTextfromHtml(String htmlText){
        ...
        try{
            result = replceLast(result,"<p>", "");
            result = replceLast(result,"</p>", "");
            if(result.endsWith("<br>")){
                result = replceLast(result, "<br>", "");
            }
            return result;
        }catch (Exception e) {
            return result;
    ...
    // Array of non-accent characters
